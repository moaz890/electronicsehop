                ...
                <div className="container flex justify-between">
                            ...
                            <ul className='flex items-center gap-4'>
                                ...
                                <li className='relative cursor-pointer group'>
                                    <a href="#" className='flex items-center gap[2px] font-semibold text-gray-500 dark:hover:text-white py-2'>Quick Links
                                        <span className='ml-1'><FaCaretDown className='group-hover:rotate-180 duration-300'/></span>
                                    </a>
                    ...
                    <div className='flex justify-between items-center gap-4'>
                        ...
                        <div className='relative group hidden sm:block'>
                            ...
                            />
                            <IoMdSearch className='text-xl text-gray-600 dark:text-gray-400 absolute top-1/2 -translate-y-1/2 right-1 group-hover:text-primary duration-200'  ></IoMdSearch>
                        </div>
